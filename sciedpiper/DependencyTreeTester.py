...
class DependencyTreeTester(ParentPipelineTester.ParentPipelineTester):
    ...
    def test_init_for_one_command(self):
        ...
        str_answer = "\n".join(["".join([
           "Graph{ Graph:VERTEX{ ID=" + str_env + "Dependency_1;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
           "VERTEX{ ID=" + str_env + "Dependency_2;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
           "VERTEX{ ID=" + str_env + "Product_1;Parents=[u'Command_1'];Children=[];Type=RESOURCE };Command: Command_1; Dependencies: PATH: " + str_env + "Dependency_1, CLEAN: 2, Dependency PARENTS: ['_i_am_Groot_'] CHILDREN: ['Command_1'],PATH: " + str_env + "Dependency_2, CLEAN: 2, Dependency PARENTS: ['_i_am_Groot_'] CHILDREN: ['Command_1']; Products: PATH: " + str_env + "Product_1, CLEAN: 2, Product PARENTS: ['Command_1'] CHILDREN: [];",
           "VERTEX{ ID=_i_am_Groot_;Parents=[];Children=[u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2'];Type=VERTEX }}" ]),
           "Products{ [u'" + str_env + "Product_1']}",
           "Dependencies{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2']}",
           "Inputs{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2']}",
           "Terminal_Products{ [u'" + str_env + "Product_1']}" ])
    ...
    def test_init_for_three_duplicate_commands(self):
        ...
        str_answer = "\n".join(["".join([
           "Graph{ Graph:VERTEX{ ID=" + str_env + "Dependency_1;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
           "VERTEX{ ID=" + str_env + "Dependency_2;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
           "VERTEX{ ID=" + str_env + "Product_1;Parents=[u'Command_1'];Children=[];Type=RESOURCE };Command: Command_1;",
    ...
    def test_init_for_two_commands(self):
        ...
        str_answer = "".join(["Graph{ Graph:",
                               "VERTEX{ ID=" + str_env + "Dependency_1;Parents=[u'_i_am_Groot_'];Children=[u'Command_1', u'Command_2'];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Dependency_2;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_1;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_2;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_3;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_4;Parents=[u'Command_2'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_5;Parents=[u'Command_2'];Children=[];Type=RESOURCE };",
                               ...
                               "VERTEX{ ID=_i_am_Groot_;Parents=[];Children=[u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2'];Type=VERTEX }}\n",
                               "Products{ [u'" + str_env + "Product_1', u'" + str_env + "Product_2', u'" + str_env + "Product_3', u'" + str_env + "Product_4', u'" + str_env + "Product_5']}\n",
                               "Dependencies{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2']}\n",
                               "Inputs{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2']}\n",
                               "Terminal_Products{ [u'" + str_env + "Product_1', u'" + str_env + "Product_2', u'" + str_env + "Product_3', u'" + str_env + "Product_4', u'" + str_env + "Product_5']}" ])
    ...
    def test_init_for_three_commands(self):
        ...
        str_answer = "".join(["Graph{ Graph:VERTEX{ ID=" + str_env + "Dependency_1;Parents=[u'_i_am_Groot_'];",
                               "Children=[u'Command_1', u'Command_2'];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Dependency_2;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_1;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_2;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_3;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_4;Parents=[u'Command_2'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_5;Parents=[u'Command_2'];Children=[u'Command_3'];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Product_6;Parents=[u'Command_3'];Children=[];Type=RESOURCE };",
                               "Command: Command_1; Dependencies: PATH: " + str_env + "Dependency_1, CLEAN: 2, ",
                               ...
                               "VERTEX{ ID=_i_am_Groot_;Parents=[];Children=[u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2'];Type=VERTEX }}\n",
                               "Products{ [u'" + str_env + "Product_1', u'" + str_env + "Product_2', u'" + str_env + "Product_3', u'" + str_env + "Product_4', u'" + str_env + "Product_5', u'" + str_env + "Product_6']}\n",
                               "Dependencies{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2', u'" + str_env + "Product_5']}\n",
                               "Inputs{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2']}\n",
                               "Terminal_Products{ [u'" + str_env + "Product_1', u'" + str_env + "Product_2', u'" + str_env + "Product_3', u'" + str_env + "Product_4', u'" + str_env + "Product_6']}" ])
...
# func_add_command
    ...
    def test_func_add_command_for_new_command_detail(self):
        ...
        str_env = os.path.join(self.str_test_directory, "test_init_for_three_commands") + os.path.sep
        str_answer = "\n".join(["Graph{ Graph:VERTEX{ ID=/Dependencies_1;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };VERTEX{ ID=" + os.path.sep + "Products_1;Parents=[u'Command_1'];Children=[];Type=RESOURCE };Command: Command_1; Dependencies: PATH: " + os.path.sep + "Dependencies_1, CLEAN: 2, Dependency PARENTS: ['_i_am_Groot_'] CHILDREN: ['Command_1']; Products: PATH: " + os.path.sep + "Products_1, CLEAN: 2, Product PARENTS: ['Command_1'] CHILDREN: [];VERTEX{ ID=_i_am_Groot_;Parents=[];Children=[u'" + os.path.sep + "Dependencies_1'];Type=VERTEX }}",
                                  "Products{ [u'" + os.path.sep + "Products_1']}",
                                  "Dependencies{ [u'" + os.path.sep + "Dependencies_1']}",
                                  "Inputs{ [u'" + os.path.sep + "Dependencies_1']}",
                                  "Terminal_Products{ [u'" + os.path.sep + "Products_1']}" ])
    ...
    def test_func_add_command_for_2_new_command_detail(self):
        ...
        str_answer = "".join(["Graph{ Graph:",
                               "VERTEX{ ID=" + str_env + "Dependencies_1;Parents=[u'_i_am_Groot_'];Children=[u'Command_1', u'Command_2'];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Products_1;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                               "VERTEX{ ID=" + str_env + "Products_2;Parents=[u'Command_2'];Children=[];Type=RESOURCE };",
                               ...
                               "VERTEX{ ID=_i_am_Groot_;Parents=[];Children=[u'" + str_env + "Dependencies_1'];Type=VERTEX }}\n",
                               "Products{ [u'" + str_env + "Products_1', u'" + str_env + "Products_2']}\n",
                               "Dependencies{ [u'" + str_env + "Dependencies_1']}\n",
                               "Inputs{ [u'" + str_env + "Dependencies_1']}\n",
                               "Terminal_Products{ [u'" + str_env + "Products_1', u'" + str_env + "Products_2']}" ])
    ...
    def test_func_add_command_for_5_new_command_detail(self):
        ...
        str_answer = "".join(["Graph{ Graph:",
                              "VERTEX{ ID=" + str_env + "Dependency_1;Parents=[u'_i_am_Groot_'];Children=[u'Command_1'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Dependency_2;Parents=[u'_i_am_Groot_'];Children=[u'Command_1', u'Command_2'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Dependency_3;Parents=[u'_i_am_Groot_'];Children=[u'Command_3'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_1;Parents=[u'Command_1'];Children=[u'Command_4'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_2;Parents=[u'Command_1'];Children=[];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_3;Parents=[u'Command_1'];Children=[u'Command_5'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_4;Parents=[u'Command_2'];Children=[u'Command_5'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_5;Parents=[u'Command_3'];Children=[u'Command_6'];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_7;Parents=[u'Command_5'];Children=[];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Product_8;Parents=[u'Command_6'];Children=[];Type=RESOURCE };",
                              "VERTEX{ ID=" + str_env + "Products_6;Parents=[u'Command_4'];Children=[];Type=RESOURCE };",
                              ...
                              "Children=[u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2', u'" + str_env + "Dependency_3'];Type=VERTEX }}\n",
                              "Products{ [u'" + str_env + "Product_1', u'" + str_env + "Product_2', u'" + str_env + "Product_3', u'" + str_env + "Product_4', u'" + str_env + "Product_5', u'" + str_env + "Product_7', u'" + str_env + "Product_8', u'" + str_env + "Products_6']}\n",
                              "Dependencies{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2', u'" + str_env + "Dependency_3', u'" + str_env + "Product_1', u'" + str_env + "Product_3', u'" + str_env + "Product_4', u'" + str_env + "Product_5']}\n",
                              "Inputs{ [u'" + str_env + "Dependency_1', u'" + str_env + "Dependency_2', u'" + str_env + "Dependency_3']}\n",
                              "Terminal_Products{ [u'" + str_env + "Product_2', u'" + str_env + "Product_7', u'" + str_env + "Product_8', u'" + str_env + "Products_6']}" ])
...
# Test func_get_commands
    ...
    def test_func_get_commands_one_command(self):
        ...
        str_answer = "".join(["[u\"Command: Command_1; ",
    ...
    def test_func_update_state_to_start(self):
        ...
        str_answer = "".join(["Graph{ Graph:VERTEX{ ID=/Dependency_1;Parents=[u'_i_am_Groot_'];",
                              "Children=[u'Command_1'];Type=RESOURCE };",
                              "VERTEX{ ID=/Products_1;Parents=[u'Command_1'];Children=[u'Command_2'];Type=RESOURCE };",
                              "VERTEX{ ID=/Products_2;Parents=[u'Command_2'];Children=[u'Command_3'];Type=RESOURCE };",
                              "VERTEX{ ID=/Products_3;Parents=[u'Command_3'];Children=[];Type=RESOURCE };",
                              ...
                              "Product PARENTS: ['Command_3'] CHILDREN: [];",
                              "VERTEX{ ID=_i_am_Groot_;Parents=[];Children=[u'/Dependency_1'];Type=VERTEX }}\n",
                              "Products{ [u'/Products_1', u'/Products_2', u'/Products_3']}\n",
                              "Dependencies{ [u'/Dependency_1', u'/Products_1', u'/Products_2']}\n",
                              "Inputs{ [u'/Dependency_1']}\n",
                              "Terminal_Products{ [u'/Products_3']}\n",
