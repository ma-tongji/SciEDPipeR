...
"""
Containts functionality for the compression of files and directories.
"""
...
class Compression:
    ...
    def __init__(self, logr_cur=None):
        ...
        self.dict_magic_number = {b"\x1f\x8b\x08": STR_COMPRESSION_GZ,
                                  b"\x42\x5a\x68": STR_COMPRESSION_BZ2,
                                  b"\x50\x4b\x03\x04": STR_COMPRESSION_ZIP,
                                  b"\x50\x4b\x05\x06\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00": STR_COMPRESSION_ZIP,
                                  b"\x50\x4b\x07\x08": STR_COMPRESSION_ZIP,
                                  b"\x1f\x9d:": STR_COMPRESSION_TAR_Z,
                                  b"\x1f\xa0:": STR_COMPRESSION_LZH_ZIP}
            ...
            if not f_test:
                ...
                for str_path_to_compress in lstr_paths:
                    ...
                    if os.path.isdir(str_path_to_compress):
                        for str_root, _, lstr_files in os.walk(str_path_to_compress):
